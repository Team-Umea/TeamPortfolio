  ...
  return (
    <div className="card">
      <div className="mt-0 mb-6 px-12 py-14 font-serif ">
        <h1 className="flex flex-col gap-y-2 pt-25 text-3xl sm:text-4xl md:text-4xl font-bold text-gray-200 bg-clip-text bg-gradient-to-r text-center relative animate-fadeIn">
          <span className="before:text-gray-500 before:absolute before:left-0 before:top-1/2 before:transform before:translate-y-[-50%]">
            Vår Resa
          </span>
          <span className="after:text-gray-500 after:absolute after:right-0 after:top-1/2 after:transform after:translate-y-[-50%] text-xl font-semibold">
