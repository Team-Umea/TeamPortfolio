...
export default function WorkflowBanner() {
  return (
    <div className="flex flex-col items-center my-24 w-[90%] max-w-[1200px] pt-8 px-12 pb-32 rounded-lg  shadow-[0_-5px_30px_rgb(255,255,255,0.2)] bg-black">
      <p className="text-2xl text-gray-300 text-center font-medium">The Team Umeå Workflow</p>
      <div className="hidden md:flex relative flex justify-between mt-16 mx-8 w-full">
      ...
      <div className="md:hidden relative flex flex-col gap-y-54 mt-16 mx-8 w-full">
        <div className="relative flex flex-col items-center z-2">
          <HiOutlineLightBulb size={44} className="p-2 rounded-full bg-black" />
