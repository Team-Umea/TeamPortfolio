  ...
  return (
    <div className="flex flex-col gap-y-2   rounded-2xl! text-gray-200">
      ...
      <div className="relative ">
        ...
        >
          {event.isEnrolled ? (
            <div className="px-6 py-3 text-2xl font-bold text-white border-1 border-white rounded-lg bg-transparent transform transition-all duration-300 hover:bg-green-700 hover:text-green-700 hover:scale-105 ">
              🎉 Du är anmäld 🎉
            </div>
          ) : (
            <TransparentButton
              onClick={() => navigate(`enroll/${event._id}`)}
              className="px-6 py-3 text-2xl font-semibold text-gray-800 border-2 border-gray-800 rounded-lg transition-all duration-300 hover:bg-gray-800 hover:text-white"
            >
      ...
      <div className="rounded-b-lg mb-[-40px] md:mb-0 ">
        <ul className="flex flex-col gap-y-4 text-gray-200 text-customColor1 font-serif text-xl p-8 pt-2 text-left">
          {text.map((t, i) => {
